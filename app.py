...
socketio = SocketIO(app, manage_session=False, async_mode='threading', logger=True, engineio_logger=True, cors_allowed_origins="*")

def create_people_counter():
    return PeopleCounterV1(threading_cam, detector, DeepSort(device='cuda', max_dist=0.5, min_confidence=0.5, nms_max_overlap=0.5, max_iou_distance=0.7, max_age=70, n_init=1, nn_budget=100), line=[(0, 120), (320, 120)])
